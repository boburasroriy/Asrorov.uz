...
<style>
    ...
    @media (width <= 425px) {
        .FeaturesSection .FeaturesSectionContentsAll{
            display: block;
        }
    }
...
<div id="about"  class="about container">
    ...
    <div class="FeaturesSection container">
        <div class="titleandsloganOffeaturesSection">
            ...
            <p>Throughout my IT career, I've improved a lot of amazing skills. <br> <span>Here's a list of them:</span></p>
        </div>
...
<div>
    ...
    <style>
        ...
        .listofprojects:hover{
            box-shadow: 0.5px 0.5px 1px 1px #EB4432;
        }
        .listofprojects h6{
            margin-top: 100px;
            color: black;
...
{{--        @foreach($applications as $application)--}}
        @if(session('success'))
            <div >
            <p style="display: flex; justify-content: center; align-items: center; font-family: 'Segoe UI Regular'; color: white;background-color: #EB4432; width: 250px; height: 30px; border-radius: 5px;  ">Your message sent successfully!</p>
            </div>
        @endif
        @if(session('flash'))
        ...
        <form method="post" action="{{ route('home') }}">
            @csrf
            <div>
                <input placeholder="Your name" name="name" class="nameInput" type="text" required />
            </div>
            <div>
                <input class="emailInput" name="email" placeholder="Email" type="email" size="30" required />
            </div>
            <div>
                <textarea style="font-family: 'Segoe UI Regular' " placeholder="Message" name="message" class="textInput" type="text"></textarea>
            </div>
...
{{--        @endforeach--}}
    ...
    <div class="container" style="display: flex; justify-content: end; margin-top: -350px; margin-right: 300px">
        <img class="imageLaravelIcon" width="350px" height="350px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Laravel.svg/1969px-Laravel.svg.png" alt="">
    </div>
